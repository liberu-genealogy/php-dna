...
class Writer
{
    ...
    private function writeCsv(array $snpsData): array
    {
        ...
        // Write snps-compatible header
        $source = $this->snps->getSource();
        $assembly = $this->snps->getAssembly();
        fwrite($handle, "# Generated by snps (https://github.com/liberu-genealogy/php-dna)\n");
        fwrite($handle, "# Source: {$source}\n");
        fwrite($handle, "# Assembly: {$assembly}\n");

        // Write column headers
        fwrite($handle, implode($separator, ['rsid', 'chromosome', 'position', 'genotype']) . "\n");
